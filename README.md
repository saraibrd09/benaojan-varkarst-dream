...
Line 14 → set the address for the "inputDataWeather.mat" (only needed the first time you set up)
Line 36 → set the address for the "obsData.mat" file (just the first time you set up)
...
The model output (simulated vs ovserverd discharge) is generated from this final run.

Data availability

("Precipitation, temperature, PET, and observed discharge data used in this study were provided by [organisation] and are not included in this repository due to usage restrictions. Contact [organisation] for access.")
