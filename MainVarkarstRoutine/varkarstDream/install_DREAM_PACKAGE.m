...
%%  example 10: multimodel mixture distibution: multivariate prior                                          %
...
%%  example 19: Bayesian Model Averaging                                                                    %
%%  example 20: GLUE - limits of acceptability: Soil temperature modeling                                   %
%%  example 21: GLUE - limits of acceptability: HYDRUS-1D model                                             %
%%  example 22: GLUE - limits of acceptability: Nash-Cascade example                                        %
%%  example 23: GLUE - limits of acceptability: SAC-SMA model                                               %
%%  example 24: FDC Fitting: van Genuchten 3 parameter model ( see FDCFIT toolbox )                         %
%%  example 25: Geomorphology: Analytic solution depth to bedrock                                           %
%%  example 26: Data assimilation Lorenz model (SODA approach: see Vrugt et al., 2005)                      %
%%  example 27: Data assimilation single layer interception model (SODA approach: see Vrugt et al., 2003)   %
%%  example 28: Joint inference of rainfall and hmodel parameters using streamflow data                     %
%%  example 29: Gaussian mixture distribution with prior distribution                                       %
%%  example 30: Predator prey model                                                                         %
%%  example 31: Linear model with Kalman proposal distribution                                              %
%%  example 32: Gaussian mixture distribution with discrete parameter space                                 %
%%  example 33: HYMOD rainfall-runoff model with Kalman proposal distribution                               %
%%  example 34: Linear model with likelihood 18 ( see DREAM Suite manual ) - model selection test           %
%%  example 35: rainfall-runoff with skewed Student t density
%%  example 36: rainfall-runoff with improved skewed exponential power (generalized likelihood)
%% 
